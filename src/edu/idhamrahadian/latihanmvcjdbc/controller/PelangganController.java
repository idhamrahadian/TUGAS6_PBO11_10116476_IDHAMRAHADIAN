...
import edu.idhamrahadian.latihanmvcjdbc.view.PelangganView;
...
public class PelangganController {
    ...
    public void insertPelanggan(PelangganView view) {
        ...
        if (nama.trim().equals("")) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(view, "DatabaseError");
            }
        }
    }
    ...
    public void deletePelanggan(PelangganView view) {
        ...
        if (JOptionPane.showConfirmDialog(view, "Anda yakin akan mengahpus?")==JOptionPane.OK_OPTION) {
            Integer id = Integer.parseInt(view.getTxtId().getText());
            model.setId(id);
